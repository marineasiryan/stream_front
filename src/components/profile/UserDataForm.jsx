...
const UserDataForm = () => {
  ...
  const changeHandler = async (e) => {
    ...
    try {
      ...
      // formdata.append("teamNameNumber", userCurData.teamNameNumber);
  ...
  return (
    <>
      <div className="account-left_sec">
      ...
      <div className="account-right_sec">
        {userCurData && (
          <form className="account-right_sec-form" onSubmit={changeHandler}>
